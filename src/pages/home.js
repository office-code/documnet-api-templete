...
//   useEffect(()=>{
//     setcontentpera(content.introduction[0])
//   },[])
//   console.log(contentpera, "content")
//   return (
//     <div className="box-dashboard-r">
//       <div className="dashboard-wrapper">
//         <div className="container">
//           <h4 className="h4-heading">Introduction</h4>
//               <div className="heading-box">
//                 <p className="p-pera">{contentpera.pracontent}</p>
