...
export default function Methods() {
    ...
    useEffect(() => {
        trackPromise(
            new Promise((resolve) => {
                setTimeout(() => {
                    setcontentdata(code.data)
                    setJsonData(code.data.request[0].data[0])
                    setJsonData200(code.data.response[0].code200)
                    setJsonData400(code.data.response[1].code400)
                    setJsonData401(code.data.response[2].code401)
                    setJsonData500(code.data.response[3].code500)
                    setJsonData501(code.data.response[4].code501)
                    ...
                    {promiseInProgress === true ? (
                        ...
                        <>
                            ...
                            <div>
                                ...
                                <h4 className="h4-heading">{contentdata.titlename}</h4>
                                <p className="p-pera">{contentdata.patacontent}</p>
                                <Row>
                                    <Col lg={6}>
                                        <div className="heading-box">
                                            <h4 className="h4-heading">{contentdata.titlename1}</h4>
                                            <p className="p-pera"><strong>{contentdata.method}</strong>{contentdata.apiname}</p>
                                            <p className="p-pera">{contentdata.apiurl}</p>
                                            <p className="p-pera">{contentdata.shortpara}</p>
                                            <p className="error-heading-pra">{contentdata.header}</p>
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td className='error-t-body error-body-text'>{contentdata.contenttype}</td>
                                                        <td className='error-t-body-head error-body-text'>
                                                            <p>{contentdata.applijson}</p>
                                                            <p>{contentdata.contenttypecontent}</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td className='error-t-body error-body-text'>{contentdata.accept}</td>
                                                        <td className='error-t-body-head error-body-text'>
                                                            <p>{contentdata.applijson}</p>
                                                            <p>{contentdata.acceptcontent}</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td className='error-t-body error-body-text'>{contentdata.origin}</td>
                                                        <td className='error-t-body-head error-body-text'>
                                                            <p>developer.ecobank.com</p>
                                                            <p>{contentdata.origincontent}</p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
