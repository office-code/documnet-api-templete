        ...
        <div className="box-dashboard-r">
            <div className="dashboard-wrapper">
                <div className="container">
                    ...
                    <p className="error-heading-pra">Setting up a Callback URL</p>
                    <ul>
                        <li className="p-pera">Transfer and RequestToPay APIs are Asynchronous in MTN MoMo API Platform</li>
                        <li className="p-pera">When a merchant system sends a POST of either /transfer, or /requesttopay APIs, the Gateway validates the request and then responds with “202 Accepted”</li>
                        <li className="p-pera">The transaction is then queued for processing.</li>
                        <li className="p-pera">Once processed, a callback with the final result of the transaction is sent to the merchant system</li>
                    ...
                    <div>
                        <h4 className="h4-heading">Approved Intermediate CA's for Open API</h4>
                        <p className="p-pera">For Open API callbacks to function, the 3PP Intermediate certificate chains must be imported on the PG’s tls_keystore and callback URL’s are required to use https L7 protocol:</p>
                        <ul>
                            <li className="p-pera">CN – Refers to the Common name of the immediate intermediate CA Chain</li>
                            <li className="p-pera">Alias – Name that is used while storing the Certificate in PG’s tls_keystore</li>
                        </ul>
